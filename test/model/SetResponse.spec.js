...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwitchDatabaseRestApi.SetResponse();
  });
  ...
  describe('SetResponse', function() {
    it('should create an instance of SetResponse', function() {
      // uncomment below and update the code to test SetResponse
      //var instane = new SwitchDatabaseRestApi.SetResponse();
      //expect(instance).to.be.a(SwitchDatabaseRestApi.SetResponse);
    });
